...
import { FacetComponent } from "../components/facet.component";
...
//   private searchOutput: SearchOutputComponent;
  ...
  async selectHiglights(value: string) {
  ...
  async getFacetButtonVisibility(titile: string) {
    return this.facetComponent.getSelectedFacetButtonVisibility(titile);
  }
